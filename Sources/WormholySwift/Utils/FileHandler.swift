...
internal class FileHandler: NSObject {

    internal static func writeTxtFile(text: String, path: String){
        FileManager.default.createFile(atPath: path, contents: text.data(using: .utf8, allowLossyConversion: true), attributes: nil)
    }
    
    internal static func writeTxtFileOnDesktop(text: String, fileName: String){
